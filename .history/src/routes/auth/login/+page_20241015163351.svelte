...
<div class="min-h-screen bg-gradient-to-r  flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-2xl border border-[#102C57]">
    ...
    <form method="post" use:enhance class="space-y-6 mt-8">
      ...
      />
      <SubmitButton
        class="w-full bg-[#102C57] text-white rounded-xl py-3 px-4 hover:bg-[#1e3a6d] transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105"
      />
    </form>
