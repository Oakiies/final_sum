...
<div class="mx-20 sm:mx-28 md:mx-40 lg:mx-60 xl:mx-[34rem] mt-10 space-y-10">
    ...
    <form method="post" use:enhance class="space-y-6">
        <InputField
            type="text"
            name="identifier"  <!-- แก้จาก email เป็น identifier -->
            label="อีเมล / ชื่อผู้ใช้งาน"
            bind:value={$form.identifier}  <!-- แก้ bind เป็น identifier -->
            errorMessage={$errors.identifier}  <!-- แก้ error message เป็น identifier -->
