	...
	<div class="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-2xl transform transition-all hover:scale-105">
	  ...
	  <form method="post" use:enhance class="mt-8 space-y-6" action={route('registerUser /auth/register')}>
		...
		<div class="pt-8 border-t border-gray-200">
		  <p class="text-lg font-semibold text-gray-700 mb-4">ข้อมูลส่วนตัว</p>
		...
		<div>
		  <SubmitButton class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-300">
			ยืนยันการสมัคร
		  </SubmitButton>
		</div>
	  </form>
