<script>
	...
	const ChangeTicketForm = ({ trip }) => `
	  <form action="search_change" method="get">
	    ...
	    <button type="submit" class="btn bg-blue-600 hover:bg-blue-700 text-white font-normal py-2 px-4 rounded-md transition duration-300 ease-in-out transform hover:scale-105">เปลี่ยนแปลงตั๋วโดยสาร
    </button>
	  </form>
	`;
