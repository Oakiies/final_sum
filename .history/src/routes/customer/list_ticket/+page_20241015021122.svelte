<script>
	...
	const ChangeTicketForm = ({ trip }) => `
	  <form action="search_change" method="get">
	   ...
	   <button type="submit" class="btn bg-blue-600 hover:bg-blue-700 text-white font-normal py-2 px-4 rounded-lg">
      เปลี่ยนแปลงตั๋วโดยสาร
    </button>
	  </form>
	`;
	<button 
		class="bg-purple-600 text-white py-2 px-4 rounded-xl shadow-lg hover:bg-purple-700 transition duration-300">
		ปุ่มอิสระ
	  </button>
